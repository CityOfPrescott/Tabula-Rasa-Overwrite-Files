...
gulp.task('tr-footer', ['tr-functions'], function() {
    ...
    return gulp.src('footer.php')
		.pipe(replace('http://automattic.com/', 'http://www.third-law.com/'))
		.pipe(replace('Automattic', 'Third Law Web Design'))
		.pipe(gulp.dest(''))
...
gulp.task('tabula-rasa', ['tr-js', 'tr-move', 'tr-functions', 'tr-footer', 'tr-del', 'tr-style', 'tr-bigmove']);
